...
// //   return (
// //     <section className=" p-5 mb-10 max-sm:p-2 max-sm:mx-5">
// //       <h1 className="text-[#00040f] dark:text-slate-300 font-bold text-5xl text-center max-sm:text-4xl ">SKILLS</h1>
// //       <div className="grid place-content-center p-5 grid-cols-2 gap-2 mt-10 " data-aos="slide-up">
